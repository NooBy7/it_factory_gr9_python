...
first_name.send_keys('Ala Bala Portocala')  #metoda este o metoda care scrie ceva intr-un camp din browser

sleep(3)  #folosim metoda ca sa putem sa instruim sistemul sa astepte purin inainte sa mearga mai departe
chrome.quit()

#----------------------------------------------

s = Service(ChromeDriverManager().install()) #stocam seviciul de chrome
